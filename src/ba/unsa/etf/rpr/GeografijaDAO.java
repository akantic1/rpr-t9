...
public class GeografijaDAO {
    ...
    public GeografijaDAO() {
        try {
            ...
            String prvi = "INSERT INTO grad(id, naziv, broj_stanovnika, drzava) " +
                    "VALUES (1, 'Pariz', 2206488, 6)";

            String drugi = "INSERT INTO grad(id, naziv, broj_stanovnika, drzava) " +
                    "VALUES (2, 'London', 8825000, 7)";

            String treci = "INSERT INTO grad(id, naziv, broj_stanovnika, drzava) " +
                    "VALUES (3, 'Beč', 1899055, 8)";

            String cetvrti = "INSERT INTO grad(id, naziv, broj_stanovnika, drzava) " +
                    "VALUES (4, 'Manchester', 545500, 7)";

            String peti = "INSERT INTO grad(id, naziv, broj_stanovnika, drzava) " +
                    "VALUES (5, 'Graz',  280200, 8)";

            String sesti = "insert into drzava(id, naziv, glavni_grad) " +
                    "values (6, 'Francuska', 1)";
            String sedmi = "insert into drzava(id, naziv, glavni_grad)" +
                    "values(7, 'Velika Britanija', 2)";
            String osmi = "insert into drzava(id, naziv, glavni_grad)" +
                    "values(8, 'Austrija', 3)";
            ...
            try {
                ...
                stmt.executeUpdate(prvi);
                stmt.executeUpdate(drugi);
                stmt.executeUpdate(treci);
                stmt.executeUpdate(cetvrti);
                stmt.executeUpdate(peti);
                stmt.executeUpdate(sesti);
                stmt.executeUpdate(sedmi);
                stmt.executeUpdate(osmi);
